...
parameter logic [31:0] INSN_XPERM4 = { 7'b0010100, 10'b?, 3'b010, 5'b?, {OPCODE_OP} };
parameter logic [31:0] INSN_XPERM8 = { 7'b0010100, 10'b?, 3'b100, 5'b?, {OPCODE_OP} };
...
parameter logic [31:0] INSN_ZIP    = { 12'b000010001111, 5'b? , 3'b001, 5'b?, {OPCODE_OP_IMM} };
parameter logic [31:0] INSN_UNZIP  = { 12'b000010001111, 5'b? , 3'b101, 5'b?, {OPCODE_OP_IMM} };

parameter logic [31:0] INSN_BREV8  = { 5'b01101, 2'b?, 5'b00111, 5'b? , 3'b101, 5'b?, {OPCODE_OP_IMM} };
...
// AES instructions four 
parameter logic [31:0] AES32ESMI = { 2'b? , 5'b10011, 10'b?, 3'b000, 5'b?, {OPCODE_OP} };
parameter logic [31:0] AES32ESI  = { 2'b? , 5'b10001, 10'b?, 3'b000, 5'b?, {OPCODE_OP} };
parameter logic [31:0] AES32DSI  = { 2'b? , 5'b10101, 10'b?, 3'b000, 5'b?, {OPCODE_OP} };
parameter logic [31:0] AES32DSMI = { 2'b? , 5'b10111, 10'b?, 3'b000, 5'b?, {OPCODE_OP} };

// SHA instructions 
// SHA256 Zknh instructions
parameter logic [31:0] SHA256SIG0 = { 2'b0, 10'b0100000010, 5'b?, 3'b001, 5'b?, OPCODE_OP_IMM };
parameter logic [31:0] SHA256SIG1 = { 2'b0, 10'b0100000011, 5'b?, 3'b001, 5'b?, OPCODE_OP_IMM };
parameter logic [31:0] SHA256SUM0 = { 2'b0, 10'b0100000000, 5'b?, 3'b001, 5'b?, OPCODE_OP_IMM };
parameter logic [31:0] SHA256SUM1 = { 2'b0, 10'b0100000001, 5'b?, 3'b001, 5'b?, OPCODE_OP_IMM };
